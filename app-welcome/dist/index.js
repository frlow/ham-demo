...
function isUpper(input, index2) {
  const code = input.charCodeAt(index2);
...
function escape$1(strings, ...values) {
  const stringsLength = strings.length, valuesLength = values.length;
  let index2 = 0, result = "";
  for (; index2 < stringsLength; index2++) {
    result += strings[index2];
    if (index2 < valuesLength) {
      result += values[index2];
    }
  }
  return escapeHtml$4(result);
}
let escapeHtml$4 = function(value) {
...
function styleToString(style) {
  ...
  let key, value, end, start, index2 = 0, result = "";
...
function attributesToString$1(attributes) {
  ...
  let key, value, type3, end, start, classItems, valueLength, result = "", index2 = 0;
  for (; index2 < length; index2++) {
    key = keys[index2];
    ...
    if (key === "className") {
      ...
      if (typeof value === "string") {
        ...
        result += attributesToString$1(value);
      }
      continue;
    }
    type3 = typeof value;
...
function contentsToString$1(contents, escape2) {
  ...
  for (let index2 = 0; index2 < length; index2++) {
    ...
    if (Array.isArray(content)) {
      contents.splice(index2--, 1, ...content);
      length += content.length - 1;
      continue;
    }
    return Promise.all(contents.slice(index2)).then(function resolveContents(resolved) {
      resolved.unshift(result);
      return contentsToString$1(resolved, escape2);
    });
  }
  if (escape2 === true) {
    return escapeHtml$4(result);
...
function contentToString$1(content, safe) {
  switch (typeof content) {
    case "string":
      return safe ? escapeHtml$4(content) : content;
    case "number":
    case "boolean":
    case "bigint":
  ...
  if (Array.isArray(content)) {
    return contentsToString$1(content, safe);
  }
  return content.then(function resolveContent(resolved) {
    return contentToString$1(resolved, safe);
  });
}
function createElement(name, attrs, ...children) {
  ...
  if (children.length === 0) {
    return isVoidElement$1(name) ? "<" + name + attributes + "/>" : "<" + name + attributes + "></" + name + ">";
  }
  const contents = contentsToString$1(children, hasAttrs && attrs.safe);
...
function compile$1(htmlFn, strict = true, separator = "/*\0*/") {
  ...
  let index2 = 0;
  for (; index2 < length; index2++) {
    if (html2[index2] === "`" && html2.slice(index2 - sepLength, index2) !== separator && html2.slice(index2 + 1, index2 + sepLength + 1) !== separator) {
      body += html2.slice(nextStart, index2) + "\\`";
      nextStart = index2 + 1;
    }
  }
...
const Html = {
  ...
  attributesToString: attributesToString$1,
  toKebabCase,
  isUpper,
  styleToString,
  createElement,
  h: createElement,
  contentsToString: contentsToString$1,
  contentToString: contentToString$1,
  compile: compile$1,
  Fragment: Fragment$1
};
html.exports = Html;
...
jsxRuntime.exports = JsxRuntime;
jsxRuntime.exports.default = JsxRuntime;
...
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/about", children: "About us" })
  ] });
};
const About = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "About us!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Some text about us...." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:mail@example.com", children: "mail@example.com" })
  ] });
};
const app = express$1();
app.get("/", (req2, res2) => {
  ...
  res2.send(
    `<!doctype html>${/* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) })}`
  );
});
app.get("/about", (req2, res2) => {
  res2.setHeader("content-type", "text/html");
  res2.send(
    `<!doctype html>${/* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(About, {}) })}`
  );
});
const port = 3444;
